...
export const JOB_LIST_LOAD_MORE_REQUEST = "JOB_LIST_LOAD_MORE_REQUEST";
export const JOB_LIST_LOAD_MORE_SUCCESS = "JOB_LIST_LOAD_MORE_SUCCESS";
export const JOB_LIST_LOAD_MORE_FAIL = "JOB_LIST_LOAD_MORE_FAIL";
